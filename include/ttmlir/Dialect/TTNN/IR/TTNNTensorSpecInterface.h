...
#ifndef TTMLIR_DIALECT_TTNN_IR_TTNN_TENSOR_SPEC_INTERFACE_H
#define TTMLIR_DIALECT_TTNN_IR_TTNN_TENSOR_SPEC_INTERFACE_H
...
#include "ttmlir/Dialect/TTNN/IR/TTNNTensorSpecInterface.h.inc"
